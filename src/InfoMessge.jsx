  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        console.error('Image cannot be loaded:\n ', error);
      }
    })();
  }, []);
  ...
  return (
    <div className="mx-auto max-w-md bg-white flex px-8 py-4 rounded-xl">
      <div className="pr-7">
        <img
          ...
          onError={({ currentTarget }) => {
            ...
            currentTarget.classList.add('object-top')
          }}
          alt={altImg}
      ...
      <div className="space-y-0.5">
        ...
        <button className="transition-all px-4 py-1 text-sm text-purple-600 font-semibold rounded-full border border-purple-200 hover:text-white hover:bg-purple-600 hover:border-transparent focus:outline-none focus:ring-2 focus:ring-purple-600 focus:ring-offset-2">
          Message
        </button>
      </div>
    </div>
